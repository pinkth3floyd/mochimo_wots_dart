  ...
  group('Datagram', () {
    group('serialization', () {
      test('should serialize and deserialize datagram', () {
        ...
        expect(ByteUtils.areEqual(deserialized.getSourceAddress(), sourceAddr), isTrue);
        expect(ByteUtils.areEqual(deserialized.getDestinationAddress(), destAddr), isTrue);
        expect(ByteUtils.areEqual(deserialized.getChangeAddress(), changeAddr), isTrue);
        
        expect(ByteUtils.areEqual(deserialized.getSignature(), signature), isTrue);
      });
    ...
    group('address handling', () {
      ...
      test('should handle destination address', () {
        ...
        expect(ByteUtils.areEqual(datagram.getDestinationAddress(), addr), isTrue);
    ...
    group('amount handling', () {
      test('should handle total send amount', () {
        ...
        expect(ByteUtils.readLittleEndianUnsigned(buffer).toInt(), equals(1000000));
      ...
      test('should handle total change amount', () {
        ...
        expect(ByteUtils.readLittleEndianUnsigned(buffer).toInt(), equals(500000));
      ...
      test('should handle fee amount', () {
        ...
        expect(ByteUtils.readLittleEndianUnsigned(buffer).toInt(), equals(10000));
    ...
    group('cloning', () {
      test('should create exact copy', () {
        ...
        expect(clone.getCurrentBlockHeight(), equals(original.getCurrentBlockHeight()));
